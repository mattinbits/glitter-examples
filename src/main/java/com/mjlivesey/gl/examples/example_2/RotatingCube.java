 ...
 */
public class RotatingCube  implements ProgramHolder {

    float[] vertices = {
            /*position*/           /*colour*/
            /*forward face*/
            -1,1,1,/*0*/            0.0f, 1.0f, 0.0f,
            -1,-1,1,/*1*/            0.0f, 1.0f, 0.0f,
            1,-1,1,/*2*/            0.0f, 1.0f, 0.0f,
            1,1,1,/*3*/            0.0f, 1.0f, 0.0f,
            /*right face*/
            1,1,1,/*4*/            1.0f, 0.0f, 0.0f,
            1,-1,1,/*5*/            1.0f, 0.0f, 0.0f,
            1,-1,-1,/*6*/            1.0f, 0.0f, 0.0f,
            1,1,-1,/*7*/            1.0f, 0.0f, 0.0f,
            /*left face*/
            -1,1,-1,/*8*/            0.0f, 0.0f, 1.0f,
            -1,-1,-1,/*9*/            0.0f, 0.0f, 1.0f,
            -1,-1,1,/*10*/            0.0f, 0.0f, 1.0f,
            -1,1,1,/*11*/            0.0f, 0.0f, 1.0f,
            /*back face*/
            1,1,-1,/*12*/            0.9f, 0.9f, 0.9f,
            1,-1,-1,/*13*/            0.9f, 0.9f, 0.9f,
            -1,-1,-1,/*14*/            0.9f, 0.9f, 0.9f,
            -1,1,-1,/*15*/            0.9f, 0.9f, 0.9f,
            /*top face*/
            -1,1,-1,/*16*/            0.1f, 0.1f, 0.1f,
            -1,1,1,/*17*/            0.1f, 0.1f, 0.1f,
            1,1,1,/*18*/            0.1f, 0.1f, 0.1f,
            1,1,-1,/*19*/            0.1f, 0.1f, 0.1f,
            /*bottom face*/
            -1,-1,1,/*20*/            1.0f, 1.0f, 0.5f,
            -1,-1,-1,/*21*/            1.0f, 1.0f, 0.5f,
            1,-1,-1,/*22*/            1.0f, 1.0f, 0.5f,
            1,-1,1,/*23*/          1.0f, 1.0f, 0.5f
    ...
    Geometry cubeGeometry = new DirectColourGeometry(vertices,vertex_indices);
    ...
    public RotatingCube(long completeRotationTime, float [] axis)
    {
    ...
    public Program getProgram() {
        return cubeGeometry.getProgram();
    }
    ...
    public void renderWithProgram(Matrix4f vpMatrix, long elapsedTime) {
        ...
        cubeGeometry.renderWithProgram(mvpMatrix,0);
    }
